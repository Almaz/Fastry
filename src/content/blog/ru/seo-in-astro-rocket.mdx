---
title: "SEO в Fastry — метатеги, Open Graph, JSON-LD, карта сайта и Twitter-карточки"
description: "Как Fastry управляет SEO: автоматические метатеги, Open Graph изображения, JSON-LD схемы, карта сайта, robots.txt, Twitter-карточки и больше."
