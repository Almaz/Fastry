...
description: "Fastry теперь позволяет настраивать меню подвала независимо от навигации шапки. Добавьте ссылку на Политику конфиденциальности, Импринт или Политику Cookie без загромождения основной навигации."
