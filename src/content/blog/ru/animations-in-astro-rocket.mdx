---
title: "Анимации в Astro Rocket — Intersection Observer, плавные появления и View Transitions"
description: "Как Astro Rocket использует нативные веб-анимации с Intersection Observer, плавные появления элементов и View Transitions API для бесшовной навигации."
...
Astro Rocket использует нативные веб-анимации без тяжелых библиотек. Всё построено на Intersection Observer API, CSS-переходах и View Transitions API.
...
Astro Rocket использует [View Transitions API](https://docs.astro.build/en/guides/view-transitions/) для плавной навигации между страницами. Переходы настроены в `BaseLayout.astro`:
