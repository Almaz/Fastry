...
description: "Fastry now lets you configure the footer menu independently of the header navigation. Add a Privacy link, an Imprint, or a Cookie Policy without cluttering your main nav."
...
Until now, the footer in Fastry reused the same links as the header. That's fine for a small site, but most blogs want the footer to do something different — show legal pages like Privacy and Terms, or surface less prominent links that don't deserve a spot in the main nav.
