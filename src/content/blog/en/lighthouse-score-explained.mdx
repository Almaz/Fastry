...
A perfect Lighthouse score isn't a trophy — it's a signal. It tells a visitor that the site they're about to use is fast, that it works on assistive tech, that it's built cleanly, and that search engines can find it. For a designer-developer's portfolio and for a free, MIT-licensed starter template I share with other builders, "100 across the board" is the bar I work to. This site and the Astro Rocket demo both clear it today, and every change I make to either site is weighed against keeping it that way.
