---
title: "Getting Started with Fastry — From Install to Live in Minutes"
description: "How to install, configure, and deploy Fastry — covering site.config.ts, brand colours, navigation, writing posts, and deploying to Vercel."
...
This guide walks you through everything needed to get Fastry running locally, configured to your brand, and deployed to the web. No previous Astro experience required.
...
Fastry is free and open source. Clone the repository from GitHub and install dependencies:
...
Fastry ships with 12 ready-to-use colour themes. Pick your preferred theme by setting the `data-theme` attribute in `src/layouts/BaseLayout.astro`:
...
Fastry also supports [Netlify](https://netlify.com) out of the box. A `netlify.toml` is included with the correct build settings and security headers pre-configured.
...
If Fastry saved you time, a [star on GitHub](https://github.com/hansmartensdev/astro-rocket) helps other developers find it. Takes two seconds.
