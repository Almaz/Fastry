...
description: "Fastry renders an optional TOC on blog posts in three layouts — inline card, sticky sidebar, or both — with the sidebar on the left or right. Pick what fits your audience."
...
Fastry ships a built-in TOC component for blog posts with three layout options — pick the one that fits your audience. Every option is **opt-in**: when the TOC is disabled, no extra HTML and no extra JavaScript reach the page.
