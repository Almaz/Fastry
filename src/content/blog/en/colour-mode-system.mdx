---
title: "System, Light, Dark — How Fastry's Colour-Mode System Works"
...
Fastry ships a 3-state colour-mode system — **System / Light / Dark** — that resolves all of those. The user picks their preference, the page never flashes the wrong theme, and 'System' tracks the operating system live. This post walks through how it is built and how the header pill exposes it.
