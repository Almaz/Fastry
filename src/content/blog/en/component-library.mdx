---
title: "57 Components Ready to Use — Fastry's Full UI Library"
description: "Fastry ships with 57 production-ready components from the Velocity library — buttons, cards, dialogs, forms, data display, and full page-structure components. All accessible, all themed."
...
Fastry inherits a complete UI component library from [Velocity](https://github.com/southwellmedia/velocity) by Southwell Media. That means 57 production-ready components are available the moment you install the theme — no npm packages to install, no extra setup. Every component is already styled with the design system's color tokens, so they adapt automatically when you switch themes or toggle dark mode.
...
<Accordion items={[
  { title: 'What is Fastry?', content: 'A production-ready Astro 6 theme.' },
...
This showcase is built into Fastry itself. All 57 components are rendered there — same markup, same variants, same props you will use in your own project.
